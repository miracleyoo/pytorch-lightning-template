...
class RDNFuse(nn.Module):
    def __init__(self, scale,
        ...
        super().__init__()
        self.scale = scale
        self.in_bands_num = in_bands_num
        self.block_num = block_num
        self.rdn_size = rdn_size
        self.rdb_growrate = rdb_growrate
        self.rdb_conv_num = rdb_conv_num
        self.mean_sen = mean_sen
        self.std_sen = std_sen
